...
of a Principal Component Analysis of the relative abundance of the first 25 dominant species across North-Eastern America (figure \ref{pca}).
...
\textit{This work was supported by the Forest Complexity Modelling program
...
Modelling, (responsible for CMIP) which made available the Global Climate
...
\begin{figure}
       \includegraphics[width=\textwidth]{figs/sp_pca.pdf}
       \caption[Principal component analysis on the first 25 dominant species in Eastern North America]{Principal component analysis of the first 25 dominant species (in terms of the basal area) in Eastern North America. This unconstrained ordination used site/species matrix, with Hellinger transformation. Data are represented in a Euclidean space. The first axis, representing 11\% of the variance, illustrates the divergence in species composition among boreal and temperate communities.}
       \label{pca}
\end{figure}
