...
\Titre{BIOGÉOGRAPHIE ET DYNAMIQUE DE LA FORÊT TEMPÉRÉE NORDIQUE DANS UN CONTEXTE DE CHANGEMENTS CLIMATIQUES} % Mettre en majuscule!! (je nai pas résolu ce probleme...)
...
\begin{singlespace}
  ...
  \bibliography{Master.bib} % Ici mettre le nom de la biblio, ici mylib.bib
\end{singlespace}
